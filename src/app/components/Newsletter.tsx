    ...
    <section className="py-5">
      <div className="max-w-[693px] mx-auto text-center">
        <div className="flex flex-col items-center gap-[8px] w-full max-w-[613px] mx-auto px-4 md:px-8">
          <h2 className="text-2xl md:text-4xl font-bold text-[#002F5B]">
          Join the Grid
          </h2>
        ...
        <div className="bg-white mx-4 md:h-[70px] h-[58px] [@media(max-width:425px)]:h-fit flex items-center border border-[#F25417] rounded-lg px-[17px] md:py-[15px] py-[6px] shadow-sm">
